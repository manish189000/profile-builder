  ...
  return (
    <>
      ...
      <div className="w-full px-4 py-3 border-b-gray-200  flex flex-wrap items-center gap-8 sm:flex-col">
        <Link className="sm:w-full" to={"general-chat"}>
          <div className="service w-[300px]  sm:w-full h-60 sm:h-[220px] shadow-lg rounded-md p-6 flex flex-col gap-3 cursor-pointer group sm:p-0 sm:border-b-2 sm:shadow-none sm:justify-center">
        ...
        <Link className="sm:w-full" to={"career-counsellor-chat"}>
